            ...
            <div className="mx-auto w-full max-w-lg space-y-5 bg-gray-800 text-white rounded-xl p-10 border border-gray-200 shadow-md ">
                ...
                <form onSubmit={handleSubmit(handleRegistration)}>
                        ...
                        {activeTab === 3 && (
                            <div className="flex flex-col items-center space-y-4">
                                <div className="flex flex-col items-center">
                                    ...
                                    {coverImagePreview ? (
                                        <img src={coverImagePreview} alt="Cover Image Preview" className="w-full h-32 object-cover" />
                                    ) : (
                    ...
                    <div className="flex justify-between mt-4">
                        {activeTab > 0 && (
                            <button type="button" onClick={handleBack} className="bg-gray-500 text-white py-2 px-4 rounded-lg hover:bg-gray-600 transition-all duration-200">
                                Back
                            </button>
                        )}
                        {activeTab < 3 && (
                            <button type="button" onClick={handleNext} className="bg-blue-500 text-white py-2 px-4 rounded-lg hover:bg-blue-600 transition-all duration-200 ml-auto">
                                Next
                            </button>
                        )}
                        {activeTab === 3 && (
                            <button type="submit" className="bg-blue-500 text-white py-2 px-4 rounded-lg hover:bg-blue-600 transition-all duration-200 ml-auto">
                                Create Account
                            </button>
                        )}
                    </div>
